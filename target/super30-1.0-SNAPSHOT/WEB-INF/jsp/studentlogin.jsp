<%-- 
    ...
    Created on : 16-Mar-2023, 5:21:16 pm
    Author     : shruti
--%>
...
<body>
    <section style="background-image: url(https://images.static-collegedunia.com/public/college_data/images/campusimage/1567662778accad.png); background-size: cover; background-blend-mode: lighten; height: 100vh; position: relative; text-align: center;" class="login_admin" >
        <button style="margin-top: 25px; margin-bottom: 80px; padding: 8px 12px; font-size: 22px; font-weight: 700; border-radius: 5px; " class="admin_button">Student Login</button>
        <section style="display: flex;justify-content: center;align-items: center;" class="form-container">
             <form style="border: 2px solid black; background-color:whitesmoke;width:max-content; padding: 60px 60px 60px 60px; border-radius: 25px;" action="processform1" name="myForm1" onsubmit="return validateForm()" method="post">
