    ...
    <body>
        ...
        PreparedStatement stmt=null;
            ...
            while(rs.next())
             {
            %>
            <form action="updtiform" method="post">
            <div align="center">
           ...
           <input type="text" name="name" value="<%=rs.getString("student_NAME")%>">
            ...
            <div class="row"><!-- comment -->
             <label> ia1</label>
           <input type="text" name="ia1" value="<%=rs.getString("ia1")%>">
            <label>ia2</label><!-- comment --> 
                <input type="text" name="ia2" value="<%=rs.getString("ia2")%>">
            </div>
            <br>
            <div class="row"><!-- comment -->
                <label> ia3</label>
                <input type="text" name="ia3" value="<%=rs.getString("ia3")%>">                
                 <label>ia4 </label>
                  <input type="text" name="ia4" value="<%=rs.getString("ia4")%>">
            </div>
            <br>
            <div ALIGN="CENTER">
