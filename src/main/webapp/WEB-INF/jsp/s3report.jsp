...
ResultSet rs=st.executeQuery("SELECT * FROM s3result WHEre prn= "+r);
...
<body>
    <section class="top_sec">
        <div class="heading">
             <form id="Form">
                       <input type="radio" onclick="document.location='s1report'" name="s1report" value="sem1"/>sem1
                          <input type="radio" onclick="document.location='s2report'" name="link" value="sem2"/>sem2
