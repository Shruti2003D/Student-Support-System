...
.home
{
   ...
   <body>
       ...
       <div class="top_sec">
       <br>
        <h1 style="text-align:center;color: #ffffff;background-color: #003366">Physics Practical marks</h1>
        <br>
<!--        <input type ="text" name="" id="myInput" placeholder="search....." style="width:50%; align-content: center"onkeyup="searchFun()">-->
  ...
  <div class="container-fluid">
   ...
   <br><br>
        <table id="myTable" align="center" border="10" width="100" style="width:70%;background-color: whitesmoke;margin-left: 10%" class="table table-hover table-dark">
...
{   
   ...
   %>
       ...
       <td><button><a href="updatepm?id=<%=id%>">Update</a></button></td>
